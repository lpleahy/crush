...
var KeybindingCatalog = []KeybindingDescriptor{
	...
	{KeybindingGroupChat, KeybindActionChatHalfPageDown, []string{"d"}, "d", "half page down", "Half page down"},
	{KeybindingGroupChat, KeybindActionChatHalfPageUp, []string{"u"}, "u", "half page up", "Half page up"},
